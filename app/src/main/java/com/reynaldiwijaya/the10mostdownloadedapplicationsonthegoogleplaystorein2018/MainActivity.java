    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent pindah = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto:", "reynaldiwijaya2306@gmail.com", null));
                if (pindah.resolveActivity(getPackageManager()) != null){
                    ...
                    Snackbar.make(view,"Donwload dlu tong aplikasi email, masa Google ga punya aplikasi email, ga punya atau ga ada kuota, malu dong!!!", Snackbar.LENGTH_LONG).setAction("Action", null).show();
                }
            }
        });
        ...
        RecyclerFragment home = new RecyclerFragment();
